...
export const ProductBuyButtons = ({ onAddToCart }: Props) => {
  return (
    <div className="flex items-center justify-between md:justify-center md:gap-10 mt-10 p-5 md:p-0">
      <button
        className="bg-primary_orange text-white border-[1px] border-transparent px-5 py-3 md:px-10 rounded-md hover:bg-opacity-80 duration-300 ease-in-out transition-colors"
        onClick={onAddToCart}
      >
        Add to cart
      </button>
